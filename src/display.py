...
def preamble():
    ...
    - Arm Pose Display Node

    This Node is used to display the raw data from the arm encoders
...
def main():
    ...
    preamble()
    rospy.init_node('arm_pose_display', anonymous=False)
    rospy.Subscriber('arm_pose', arm_msg, callback=display.calback)
    rospy.spin()
    sys.stdout.write("\n")
    sys.stdout.flush()
